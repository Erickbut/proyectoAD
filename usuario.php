...
<body>
      ...
      <div class="col-lg-3 col-md-6 col-sm-8 col-xs-12 align-middle">
         ...
         <div data-toggle="play-animation" data-play="fadeInUp" data-offset="0" class="panel panel-default panel-flat">
            ...
            <div class="panel-body">
               <form action="validar.php" method="post" class="mb-lg" enctype="multipart/form-data">
                  <div class="text-right mb-sm"><a href="NewLogin.php" class="text-muted">Need to Signup?</a>
                  </div>
                  <div class="form-group has-feedback">
                     <input id="exampleInputEmail1" name="login" type="text" placeholder="Enter usuario" class="form-control" required>
                     <span class="fa fa-envelope form-control-feedback text-muted"></span>
                  </div>
                  <div class="form-group has-feedback">
                     <input id="exampleInputPassword1" type="password" name="contrasenia" placeholder="Password" class="form-control" required>
   ...
   <script src="assets/app/js/pages.js"></script>
   <!-- END Scripts-->
